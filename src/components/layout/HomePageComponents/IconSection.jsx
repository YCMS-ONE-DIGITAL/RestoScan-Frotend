  ...
  const features = [
    {
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-qr-code-scan text-purple-600 dark:text-purple-500 size-6" viewBox="0 0 16 16">
    ...
    },
    {
      ...
      icon: (
        <svg className="size-6 transition duration-75 text-purple-600 dark:text-purple-500" fill="currentColor" viewBox="0 -0.5 25 25" xmlns="http://www.w3.org/2000/svg">
