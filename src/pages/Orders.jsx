  ...
  const Orders = () => {
    ...
    const { data, isLoading } = useQuery({
      queryKey: ["orders", page, dateRangeType, startDate, endDate, status, paymentStatus],
      queryFn: async () => {
       const res = await api.get("/restaurant/orders/filter", {
             params: { page, per_page: 6, dateRangeType, startDate, endDate },
           });
           return res.data;
      },
            ...
            {orders.map((order) => (
              ...
              >
                <OrderCard
                  ...
                  orderType={order.order_type} // ✅ Add this
