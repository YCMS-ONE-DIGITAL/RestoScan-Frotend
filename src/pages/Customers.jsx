...
export const Customers = () => {
  const staffData = [
    { id: 1, name: " Doe", email: "john@example.com", role: "Manager", joined: "12 Jan 2023" },
        ...
        <Table className="min-w-full border border-gray-200 dark:border-gray-700 rounded-lg">
          <TableHeader className="bg-gray-700 dark:bg-gray-700">
            <TableRow>
              ...
              <TableHead className="text-gray-300 dark:text-gray-300">Phone Number</TableHead>
              <TableHead className="text-gray-300 dark:text-gray-300">Total Orders</TableHead>
