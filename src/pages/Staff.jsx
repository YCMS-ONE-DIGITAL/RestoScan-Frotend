...
const Staffdetail = () => {
  ...
  // Future data can come from API or database
];
  ...
  return (
      <div className=" ">
        ...
        <div className="mb-6 flex flex-col sm:flex-row items-center justify-between">
          <h1 className="text-xl font-semibold text-white-500 dark:text-white">Staff</h1>
          ...
          <div className="flex items-center gap-4 mt-4 sm:mt-0">
            ...
            {/* Add Member */}
            <button className="px-5 py-2.5 bg-green hover:bg-skin-base/90 text-white rounded-lg text-sm">
              Add Member
            </button>
          </div>
        </div>
        ...
        <div className="overflow-x-auto">
          <Table className="min-w-full border border-gray-200  rounded-lg">
            <TableHeader className="bg-gray-800 dark:bg-gray-700">
              <TableRow>
                <TableHead className="text-gray-300 dark:text-gray-300">Name</TableHead>
                <TableHead className="text-gray-300 dark:text-gray-300">Email</TableHead>
                <TableHead className="text-gray-300 dark:text-gray-300">Role</TableHead>
                <TableHead className="text-gray-300 dark:text-gray-300">Joined</TableHead>
                <TableHead className="text-right text-gray-300 dark:text-gray-300">Actions</TableHead>
              </TableRow>
            </TableHeader>
